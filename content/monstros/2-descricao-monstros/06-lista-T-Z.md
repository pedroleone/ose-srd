...
**Ataques**: 2 × claw (1d8), 1 × bite (1d6 × 10) or breath
...
**Ataques**: 2 × claw (1d3 + paralysis) or 1 × weapon (1d6 or by weapon)
...
# Tiranossauro Rex
_Great (over 6m tall), two-legged, predatory dinosaurs with huge jaws. Hunt human-sized or larger prey. Dwell in Lost World regions._
...
# Tricerátops
_Massive (12’ to the shoulder, almost 12m long), aggressive, herbivorous dinosaurs with a protective crest behind the head, and three long horns. Dwell in Lost World grasslands._
...
**Ataques**: 2 × talon (1d6), 1 × bite (1d10)
...
**Ataques**: 1 × bite (2d4) or 1 × ram (stun)
...
* **Change form**: At will; takes 1 round:
  ...
  * **Dire wolf**: Att 1 × bite (2d4), MV 45m (15m). AC, HD, morale, saves as vampire.
  * **Giant bat**: Att 1 × bite (1d4), MV 9m (3m) / 54m (18m) flying. AC, HD, morale, saves as vampire.
...
# Verme da Carniça
_9’ long, 1m high, many-legged, segmented worms with a ring of 2’ long tentacles around their mouths._

**Classe de Armadura**: 7 [12]

**Dados de Vida**: 3+1* (14pv)

**Ataques**: 8 × tentacle (paralysis)
...
* **Paralysis**: A hit by a tentacle causes paralysis for 2d4 turns (save versus paralysis). Paralysed victims will bedevoured, if the crawler is left in peace.
...
# Vorme Púrpura
_Gigantic, slimy worms with bodies 100’ long and 8–3m thick. Bore tunnels through the earth and come to the surface to eat other creatures._

**Classe de Armadura**: 6 [13]

**Dados de Vida**: 15* (67pv)

**Ataques**: 1 × bite (2d8), 1 × sting (1d8 + poison)
...
**Ataques**: 1 × bite (2d8), 1 × sting (1d6 + poison)
